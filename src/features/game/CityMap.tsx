      ...
      {districts.map((district, index) => {
        ...
        return <g key={district.id} role="button" tabIndex={0} aria-label={`${district.name} район`} aria-pressed={isSelected}
          ...
          <g aria-hidden="true" className={mapStyles.decorative} clipPath={`url(#${mapId}-area-${index})`}>
            ...
            {index === 0 && <><Park x={227} y={86} width={64} height={55} /><Park x={54} y={63} width={40} height={47} /><g transform="translate(118 85)" className={mapStyles.landmark}><rect x="-10" y="-10" width="20" height="20" rx="5" /><path d="M-5 -5 H5 V4 H-5 Z M-5 -1 H5 M-3 4 V7 M3 4 V7" /><text x="0" y="26">Остановка</text></g></>}
            {index === 1 && <><Park x={282} y={274} width={43} height={28} /><g transform="translate(100 296)" className={mapStyles.landmark}><rect x="-11" y="-12" width="22" height="22" rx="5" /><path d="M-7 -4 L0 -9 7 -4 M-6 -3 V5 M0 -3 V5 M6 -3 V5 M-8 6 H8" /><text x="0" y="26">Площадь</text></g></>}
            {index === 2 && <><Park x={346} y={372} width={66} height={53} /><Park x={109} y={360} width={40} height={23} /><g transform="translate(181 396)" className={mapStyles.landmark}><rect x="-12" y="-12" width="24" height="22" rx="5" /><path d="M-8 5 V-4 L0 -8 8 -4 V5 Z M-3 5 V0 H3 V5 M-4 -3 H-2 M2 -3 H4" /><text x="0" y="26">Школа</text></g></>}
          </g>
